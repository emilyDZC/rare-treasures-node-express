  ...
  describe("/api", () => {
    describe("/treasures", () => {
      ...
      describe("/:id", () => {
        ...
        describe("DELETE", () => {
          it("Status 200: should successfully delete a given treasure", () => {
            return request(app)
              .delete("/api/treasures/28")
              .expect(200)
              .then(() => {
                return request(app)
                  .get("/api/treasures")
              ...
              .then(({ body }) => {
                expect(body.treasures[27]).to.equal(undefined);
              });
          });
          describe("Error handling", () => {
            it("Status 404: should handle attempt to delete nonexistent treasure", () => {
              return request(app)
                .delete("/api/treasures/200")
                .expect(404)
                .then(({ body }) => {
                  expect(body.msg).to.equal("Treasure not found!");
                });
            });
          });
        });
